...
const GradientPage: NextPage<any> = (props) => {
  ...
  const TWITTER_MESSAGE = `I found a great new gradient on Pomegradient! Check out ${gradient.name}!`
        ...
        <div className="md:col-span-4 content-start">
          <div className="md:flex md:items-end md:justify-between">
            ...
            <div className="space-y-6 mt-6 md:space-x-4 md:space-y-0 md:flex md:justify-center md:items-center">
              {user && <Heart gradientRef={gradientRef} heartCount={gradient.heartCount} />}

              <button
                type="button"
                onClick={handleCopyToClipBoard}
                className="w-full focus:outline-none md:max-w-[200px] space-x-2 inline-flex gradients-center justify-center text-[#374151] font-medium bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg shadow-sm hover:shadow-lg py-3 px-5 border border-[#D1D5DB] transform hover:-translate-y-0.5 transition-all duration-150 md:flex"
              >
                <svg
